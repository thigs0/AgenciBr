...
class Merge:
    ...
    def download(self, path, start_year=2000,start_month=1, start_day=1,
        ...
        for i in arange(start_dt, end_dt, dtype='datetime64[D]'):
            date_str_format = to_datetime(i).strftime('%Y%m%d')
        ...
        system(rf"rm {path}/*.idx")
        system(rf"rm {path}/*.grip2")
